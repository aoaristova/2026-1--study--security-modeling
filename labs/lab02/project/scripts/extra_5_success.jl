...
println("P(>$threshold успешных/час): \n  Теоретическая вероятность =", p_theor, "\n  Эмпирическая вероятность =", p_emp)
...
display(combined)
savefig(plotsdir("extra_5_success.png"))
println("График сохранён в ", plotsdir("extra_5_success.png"))